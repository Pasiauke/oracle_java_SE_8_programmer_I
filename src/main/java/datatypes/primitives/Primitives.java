...
public class Primitives {
    ...
    public void primitives() {
        ...
        System.out.println("Hex:  " + intHexadecimal + " Bin: " + intBinary + " Char: " + charUnicode);
        ...
        long longExample = 1234l;
        float floatExample = 1234.23f;
        double doubleExample = 234.1234d;
        double doubleExampleWithNotation = 155233e3;
